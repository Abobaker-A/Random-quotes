const quoter = [ { quote : "“Be yourself; everyone else is already taken.”"    , author :  '― Oscar Wilde' }   ,
...
$("#sub").click(function(){
        let random =  Math.floor(Math.random() * quoter.length )
         qoutep.html(quoter[random].quote)
         authorp.html(quoter[random].author)
